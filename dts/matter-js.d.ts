...
declare namespace Matter {
    ...
    */
    export class Matter {
         ...
         * @return {function} The chained function that replaced the original
         */
        static before(path: string, func: Function)
         ...
         * @return {function} The chained function that replaced the original
         */
        static after(path: string, func: Function);
    }
...
export class Plugin {
     ...
     */
    static resolve(dependency: string): any;
     ...
     */
    static isUsed(module, name: string): boolean;
     ...
     */
    static isFor(plugin, module): boolean;
     ...
     */
    static dependencies(module, tracked): any;
     ...
     */
    static dependencyParse(dependency: string): any;
     ...
     */
    static versionParse(range: string): any;
